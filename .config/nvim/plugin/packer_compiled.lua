...
_G.packer_plugins = {
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["format.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/format.nvim",
  ...
  gruvbox = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  neovim = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/neovim",
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
    url = "https://github.com/windwp/nvim-ts-autotag"
  },
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
  ...
  ["tokyodark.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/tokyodark.nvim",
    url = "https://github.com/tiagovla/tokyodark.nvim"
  },
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/vim-vsnip",
